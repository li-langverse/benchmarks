...
Use the sections in [research-methodology.md](../research-methodology.md) (problem, SOTA survey, method, quality table, evidence links). For **small vs large N, memory, long horizons, and external engine comparators**, anchor claims with [SOTA comparison matrix](../sota-comparison-matrix.md).
