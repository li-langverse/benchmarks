...
| 3 | E. Hairer, C. Lubich, G. Wanner — *Geometric Numerical Integration* ([structure-preserving integration overview](http://mate.uniovi.es/~carpet/GNI2006/PROGRAMME/haireryesterday.pdf)) — book: Springer GNI series | Leapfrog / Störmer-Verlet lineage for **`nbody_gravity`**, **`double_pendulum`**, **`harmonic_oscillator_chain`** — keep symplectic/stability properties when tightening timing. |
