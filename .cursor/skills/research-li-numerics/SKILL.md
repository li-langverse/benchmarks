...
**Canonical methodology:** [research-methodology.md](../../../docs/numerics/research-methodology.md)
...
- Automation [benchmark-visual-validation](../../automations/benchmark-visual-validation.md) — oracle = shared **cpp** cores
