...
Skills: **`ecosystem-first`**, `plan-feature-from-issue`, `audit-plan-completion`, `merge-approved-pr`, `write-li-release-notes`, `li-ecosystem-discipline`, `research-li-numerics`.
