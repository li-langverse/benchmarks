...
4. If queue is healthy and benches are green, improve **lic** harness kernels (goal: Li ≤1.2× cpp everywhere; beat HPC SOTAs on tier-2 physics). **Where to work:** [docs/game-dev/README.md](docs/game-dev/README.md) (catalog ↔ engine map; World Studio / composables = **lic** checkout). **Breadth (stability, N-scaling, memory, long runs, field SOTA):** [docs/numerics/sota-comparison-matrix.md](docs/numerics/sota-comparison-matrix.md) — do not claim “beats product X” from dashboard green alone.
