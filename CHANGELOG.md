...
- **Cloud VM install:** `scripts/cloud-agent-install.sh` delegates to `update-cloud-agent-env.sh` → `lic/scripts/cloud-vm-bootstrap.sh` (fixes `LLVM_DIR` unbound under `set -u`, `dashboard-next`) — [2026-05-27-fix-cloud-update-script.md](docs/release-notes/2026-05-27-fix-cloud-update-script.md).
