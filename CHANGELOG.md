...
- **Parallel tier-1/2 benches:** `BENCH_JOBS` + `scripts/run-lic-tier-benches.py` for full-suite throughput — [2026-05-27-bench-parallel-tier12.md](docs/release-notes/2026-05-27-bench-parallel-tier12.md).
