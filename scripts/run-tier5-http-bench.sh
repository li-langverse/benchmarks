...
ORACLES="${BENCH_HTTP_ORACLES:-nginx,apache,lighttpd,caddy,node,bun,li}"
export BENCH_PROXY_ORACLES="${BENCH_PROXY_ORACLES:-nginx,apache,lighttpd,caddy,traefik,li}"
