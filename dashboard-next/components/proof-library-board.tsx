...
const GITHUB_ISSUE_BASE =
  "https://github.com/li-langverse/lic/issues/new?labels=proof-opinion&title=";
  ...
  return (
    <div className="proof-library-board">
      ...
      <p className="proof-library-footer">
        Raw JSON:{" "}
        <a href={PROOF_LIBRARY_PUBLIC_URL} target="_blank" rel="noopener noreferrer">
          proof-library.json
        </a>
        {" · "}
        <Link href="/">Benchmark overview</Link>
        {" · "}
        <Link href="/pillar/proofs/">Perf pillar: proofs</Link>
      </p>
    </div>
  );
}
