...
**Sub-plan exit gates (26 open, not PH tracker):** phase-02 typechecker (3 — likely evidence exists, #470); phase-07 HPC (3); plots-and-social (4); ecosystem-governance (7, #476); math-linalg P-linalg (#472); package-scaffold (7).
...
**Existing (no new duplicate):** #463 (PH-7e reds), #387 (G-par MIR), #428/#460 (8p-a), #472 (P-linalg), #477 (httpd wrk), #521–523 (research runners idle), #471 (ingest close-on-completed-status).
