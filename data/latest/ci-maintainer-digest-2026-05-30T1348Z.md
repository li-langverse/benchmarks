# ci_maintainer proactive digest — 2026-05-30T13:48Z

Run: `ci_maintainer-1780148669725` · Agent: `ci_maintainer` · Source: proactive
...
- **GitHub REST quota** healthy (4036/5000 remaining) — audit authoritative this run.
...
- **34 failed PRs** in ecosystem-audit — triage via `ci_bug_triage` agent, not ci_maintainer add-CI scope.
