...
| fft_1d_fixed | 1 | green | 1.000× | lic |
| horner_pure_li | 1 | green | 0.833× | lic |
| matmul_blocked | 1 | yellow | 1.298× | lic |
| matmul_blocked_N1024 | 1 | unknown | — | lic |
| matmul_naive | 1 | green | 1.046× | lic |
...
| num_cholesky | 1 | green | 1.200× | lic |
| num_eig_symmetric | 1 | green | 1.000× | lic |
| num_fft_r2c | 1 | green | 0.978× | lic |
| num_gmres | 1 | green | 1.000× | lic |
| num_integ_euler | 1 | green | 1.000× | lic |
| num_integ_rk4 | 1 | green | 1.000× | lic |
| num_integ_semi_implicit | 1 | green | 1.000× | lic |
| num_integ_symplectic | 1 | green | 1.000× | lic |
| num_integ_verlet | 1 | green | 1.000× | lic |
| num_opt_bfgs | 1 | green | 1.000× | lic |
| num_opt_line_search | 1 | green | 1.042× | lic |
| num_quadrature_gauss | 1 | green | 1.000× | lic |
| num_rng_pcg | 1 | green | 1.012× | lic |
| num_root_newton | 1 | green | 1.000× | lic |
| num_sparse_mv | 1 | green | 0.982× | lic |
| reduce_sum | 1 | green | 0.614× | lic |
| simd_dot | 1 | green | 0.865× | lic |
...
| benchmark | tier | status | ratio | repo |
|---|---|---|---|---|
| advection_diffusion_2d | 2 | green | 1.006× | lic |
...
| cloth_swing | 2 | green | 1.100× | lic |
| combustion_passive | 2 | green | 1.000× | lic |
| double_pendulum | 2 | green | 0.984× | lic |
...
| harmonic_oscillator_chain | 2 | green | 0.985× | lic |
| heat_equation_2d | 2 | green | 1.024× | lic |
| md_barostat_parrinello_rahman | 2 | green | 0.994× | lic |
| md_constraints_rattle | 2 | green | 1.006× | lic |
| md_constraints_shake | 2 | green | 1.001× | lic |
| md_energy_drift | 2 | green | 1.007× | lic |
| md_init_fcc_mb | 2 | green | 0.992× | lic |
| md_integrator_leapfrog | 2 | green | 1.009× | lic |
| md_integrator_verlet | 2 | green | 0.997× | lic |
| md_lennard_jones | 2 | green | 0.996× | lic |
| md_longrange_ewald | 2 | green | 0.983× | lic |
| md_longrange_pme | 2 | green | 1.013× | lic |
| md_neighbor_cell_list | 2 | green | 0.994× | lic |
| md_neighbor_verlet_skin | 2 | green | 1.009× | lic |
| md_oracle_external | 2 | green | 1.010× | lic |
| md_thermostat_berendsen | 2 | green | 1.027× | lic |
| md_thermostat_nose_hoover | 2 | green | 1.006× | lic |
| nbody_gravity | 2 | green | 1.010× | lic |
...
| schrodinger_1d_barrier | 2 | green | 0.875× | lic |
| sph_dam_break_2d | 2 | green | 0.976× | lic |
| three_body | 2 | green | 0.991× | lic |
| three_body_pure | 2 | green | 0.973× | lic |
| wave_equation_1d | 2 | green | 1.009× | lic |
| wave_equation_2d | 2 | green | 0.989× | lic |
