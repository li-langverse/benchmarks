...
| benchmark | tier | status | ratio | repo |
|---|---|---|---|---|
| https_static | 5 | yellow | — | lis |
| keepalive_pipelining | 5 | yellow | — | lis |
| lb_least_conn | 5 | yellow | — | lis |
| lb_peer_down | 5 | yellow | — | lis |
| lb_round_robin | 5 | yellow | — | lis |
| proxy_loopback | 5 | yellow | — | lic |
| rate_limit_429 | 5 | yellow | — | benchmarks |
| static_large | 5 | yellow | — | lis |
| static_small | 5 | yellow | — | lis |
