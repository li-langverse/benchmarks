# Org repo onboarder digest — 2026-05-29T2351Z

**Agent:** `org_repo_onboarder` · **Source:** proactive sweep · discovery `2026-05-29T23:51Z` · CI audit `2026-05-29T23:35Z` · agent-kit audit `2026-05-29T23:50Z` · briefing `2026-05-29T22:07Z`
...
**Note:** `scripts/discover-new-org-repos.py` was absent on this branch; restored from git `69f1a6b` before refresh. Briefing preflight stdout showing `github=13` was from a run with wrong `ROOT` (script executed outside `benchmarks/`).
