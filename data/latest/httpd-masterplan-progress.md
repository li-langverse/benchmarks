...
## Step: step-8-wave8-tls-headers — 2026-05-21T11:44:30Z

M1 wave 8: li-tls scaffold, strip x-internal-* proxy headers, https_static tier5 stub
...
ninja: no work to do.
==> li-httpd
runtime/li_rt_net.c:617:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  617 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
runtime/li_rt_net.c:622:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  622 |     iov[iovcnt].iov_base = ptr_i(b);
      |                          ^ ~~~~~~~~
runtime/li_rt_net.c:735:10: warning: passing 'const char *' to parameter of type 'void *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  735 |   memcpy(ptr_i(p), "not found", 9);
      |          ^~~~~~~~
/usr/include/string.h:43:39: note: passing argument to parameter '__dest' here
   43 | extern void *memcpy (void *__restrict __dest, const void *__restrict __src,
      |                                       ^
runtime/li_rt_net.c:3631:29: warning: passing 'const char *' to parameter of type 'void *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
 3631 |   ssize_t n = read((int)fd, ptr_i(buf), (size_t)max_bytes);
      |                             ^~~~~~~~~~
/usr/include/unistd.h:371:38: note: passing argument to parameter '__buf' here
  371 | extern ssize_t read (int __fd, void *__buf, size_t __nbytes) __wur
      |                                      ^
runtime/li_rt_net.c:3694:10: warning: passing 'const char *' to parameter of type 'void *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
 3694 |   memcpy(ptr_i(dst) + off, ptr_i(src), (size_t)n);
      |          ^~~~~~~~~~~~~~~~
/usr/include/string.h:43:39: note: passing argument to parameter '__dest' here
   43 | extern void *memcpy (void *__restrict __dest, const void *__restrict __src,
      |                                       ^
runtime/li_rt_net.c:3702:20: warning: passing 'const char *' to parameter of type 'char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
 3702 |   int n = snprintf(ptr_i(buf), (size_t)cap,
      |                    ^~~~~~~~~~
/usr/include/stdio.h:385:39: note: passing argument to parameter '__s' here
  385 | extern int snprintf (char *__restrict __s, size_t __maxlen,
      |                                       ^
runtime/li_rt_net.c:3893:29: warning: passing 'const char *' to parameter of type 'void *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
 3893 |   ssize_t r = recv((int)fd, ptr_i(buf), (size_t)cap, 0);
      |                             ^~~~~~~~~~
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
simd_dot cpp wall_time=0.0561s (median of 1)
simd_dot rust wall_time=0.0555s (median of 1)
simd_dot julia wall_time=0.0529s (median of 1)
simd_dot li wall_time=0.0008s (median of 1)
ok simd_dot
runtime/li_rt_net.c:617:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  617 |     iov[iovcnt].iov_base = ptr_i(a);
...
matmul_naive rust wall_time=0.0025s (median of 1)
matmul_naive julia wall_time=0.0025s (median of 1)
matmul_naive li wall_time=0.0024s (median of 1)
ok matmul_naive
runtime/li_rt_net.c:617:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  617 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
matmul_blocked cpp wall_time=0.0104s (median of 1)
matmul_blocked rust wall_time=0.0102s (median of 1)
matmul_blocked julia wall_time=0.0102s (median of 1)
matmul_blocked li wall_time=0.0106s (median of 1)
ok matmul_blocked
runtime/li_rt_net.c:617:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  617 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
reduce_sum cpp wall_time=0.3242s (median of 1)
reduce_sum rust wall_time=0.3191s (median of 1)
reduce_sum julia wall_time=0.3121s (median of 1)
reduce_sum li wall_time=0.3386s (median of 1)
ok reduce_sum
runtime/li_rt_net.c:617:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  617 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
md_lennard_jones cpp wall_time=2.5948s (median of 1)
md_lennard_jones rust wall_time=2.6265s (median of 1)
md_lennard_jones julia wall_time=2.6037s (median of 1)
md_lennard_jones li wall_time=0.0031s (median of 1)
ok md_lennard_jones
runtime/li_rt_net.c:617:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  617 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
three_body cpp wall_time=0.2460s (median of 1)
three_body rust wall_time=0.2437s (median of 1)
three_body julia wall_time=0.2438s (median of 1)
three_body li wall_time=0.2435s (median of 1)
ok three_body
runtime/li_rt_net.c:617:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  617 |     iov[iovcnt].iov_base = ptr_i(a);
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
nbody_gravity cpp wall_time=1.1747s (median of 1)
nbody_gravity rust wall_time=1.1676s (median of 1)
nbody_gravity julia wall_time=1.1690s (median of 1)
nbody_gravity li wall_time=1.1719s (median of 1)
ok nbody_gravity
runtime/li_rt_net.c:617:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  617 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
harmonic_oscillator_chain cpp wall_time=0.0994s (median of 1)
harmonic_oscillator_chain rust wall_time=0.0830s (median of 1)
harmonic_oscillator_chain julia wall_time=0.0830s (median of 1)
harmonic_oscillator_chain li wall_time=0.0884s (median of 1)
ok harmonic_oscillator_chain
runtime/li_rt_net.c:617:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  617 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
wave_equation_1d cpp wall_time=1.8184s (median of 1)
wave_equation_1d rust wall_time=1.6570s (median of 1)
wave_equation_1d julia wall_time=1.7955s (median of 1)
wave_equation_1d li wall_time=1.8064s (median of 1)
ok wave_equation_1d
runtime/li_rt_net.c:617:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  617 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
heat_equation_2d cpp wall_time=0.1544s (median of 1)
heat_equation_2d rust wall_time=0.1282s (median of 1)
heat_equation_2d julia wall_time=0.1266s (median of 1)
heat_equation_2d li wall_time=0.1294s (median of 1)
ok heat_equation_2d
runtime/li_rt_net.c:617:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  617 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
double_pendulum cpp wall_time=0.3175s (median of 1)
double_pendulum rust wall_time=0.3176s (median of 1)
double_pendulum julia wall_time=0.3176s (median of 1)
double_pendulum li wall_time=0.3198s (median of 1)
ok double_pendulum
runtime/li_rt_net.c:617:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  617 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
advection_diffusion_2d cpp wall_time=0.1094s (median of 1)
advection_diffusion_2d rust wall_time=0.1360s (median of 1)
advection_diffusion_2d julia wall_time=0.1143s (median of 1)
advection_diffusion_2d li wall_time=0.1107s (median of 1)
ok advection_diffusion_2d
runtime/li_rt_net.c:617:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  617 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
wave_equation_2d cpp wall_time=0.2668s (median of 1)
wave_equation_2d rust wall_time=0.2782s (median of 1)
wave_equation_2d julia wall_time=0.2780s (median of 1)
wave_equation_2d li wall_time=0.2689s (median of 1)
ok wave_equation_2d
runtime/li_rt_net.c:617:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  617 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
sph_dam_break_2d cpp wall_time=0.8426s (median of 1)
sph_dam_break_2d rust wall_time=0.8383s (median of 1)
sph_dam_break_2d julia wall_time=0.8366s (median of 1)
sph_dam_break_2d li wall_time=0.8412s (median of 1)
ok sph_dam_break_2d
module:1:1: error [E0301]: Every `extern proc` must declare what must be true before it runs (`requires`).
module:1:1: error [E0301]: Every `extern proc` must declare what it guarantees on exit (`ensures`).
module:1:1: error [E0301]: Every `extern proc` must declare what must be true before it runs (`requires`).
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
lic_build_async lic build wall_time=0.0019s
lic_build_effects_net lic build wall_time=0.0022s
lic_build_effects_async lic build wall_time=0.0019s
lic_build_alloc lic build wall_time=0.0019s
lic_check_contracts lic build wall_time=0.0019s
async_await_chain li wall_time=0.0008s
security_security_corpus wall_time=0.1215s
security_security_cve_patterns wall_time=0.0226s
security_security_webserver_registry wall_time=0.0200s
updated /workspace/lic/benchmarks/results/latest.csv (+6 ecosystem rows)
==> tier 5 — HTTP multi-oracle (nginx, apache, lighttpd, node, bun, li)
bench_http: wrote 28 row(s) -> /workspace/vendor/lis-tier5/results/latest.csv
run-tier5-http-bench: ok (profile=nightly, oracles=nginx,apache,lighttpd,node,bun,li)
==> tier 5 — supplemental proxy_loopback (li_epoll + li c_epoll vs nginx)
2026/05/21 11:50:12 [notice] 85270#85270: signal process started
2026/05/21 11:50:54 [notice] 85314#85314: signal process started
2026/05/21 11:51:58 [notice] 85390#85390: signal process started
static_small li=95852 nginx=93892
keepalive_pipelining li=147152 nginx=133845
proxy_loopback li=0 li_c=0 nginx=67700
tier5-http-bench: wrote 7 rows -> /workspace/lic/benchmarks/results/http_tier5.csv
==> tier 5 — HTTP exploits (TIER5_EXPLOIT_PROFILE=pr)
exploit_http: 36 row(s) -> /workspace/vendor/lis-tier5/results/exploit_report.csv (0 fail)
run-tier5-http-exploits: ok (pr, langs=nginx,apache,li, csv=/workspace/vendor/lis-tier5/results/exploit_report.csv)
...
ingest-csv-smoke: skip (lic lacks std/io + std/csv — PH-IO-4)
build-summary-li: skip (lic lacks std/summary — PH-IO-7)
wrote /workspace/data/latest/summary.json (33 rows, 33 charts)
recorded 2026-05-21T115217Z.json (17 deltas vs previous)
regression check ok: 33 rows
==> benchmark status report
=== Benchmark failures report ===
Dashboard: https://li-langverse.github.io/benchmarks/
generated_at: 2026-05-21T11:52:17.854653+00:00

RED: none

GREEN near threshold (>1.0× cpp, 5):
  reduce_sum                   tier=1    1.044×  lic  PH=PH-5b
  matmul_blocked               tier=1    1.019×  lic  PH=PH-5b
  advection_diffusion_2d       tier=2    1.012×  lic  PH=PH-5b
  wave_equation_2d             tier=2    1.008×  lic  PH=PH-5b
  double_pendulum              tier=2    1.007×  lic  PH=PH-5b
...
UNKNOWN / no data (13):
  ...
  lip_smoke                    tier=3  lip
  lit_smoke                    tier=3  lit
  lb_least_conn                tier=5  lis
  lb_peer_down                 tier=5  lis
  lb_round_robin               tier=5  lis
  proxy_loopback               tier=5  lic
  tier5_http_exploits          tier=5  lis

Since last snapshot (17 deltas):
  {'benchmark': 'horner_pure_li', 'field': 'ratio_vs_cpp', 'from': 0.4444, 'to': 0.8182, 'delta': 0.3738, 'improved': False}
  {'benchmark': 'matmul_blocked', 'field': 'ratio_vs_cpp', 'from': 0.9717, 'to': 1.0192, 'delta': 0.0475, 'improved': False}
  {'benchmark': 'matmul_naive', 'field': 'ratio_vs_cpp', 'from': 0.9714, 'to': 0.6857, 'delta': -0.2857, 'improved': True}
  {'benchmark': 'reduce_sum', 'field': 'ratio_vs_cpp', 'from': 1.0039, 'to': 1.0444, 'delta': 0.0405, 'improved': False}
  {'benchmark': 'advection_diffusion_2d', 'field': 'ratio_vs_cpp', 'from': 0.9396, 'to': 1.0119, 'delta': 0.0723, 'improved': False}
  {'benchmark': 'harmonic_oscillator_chain', 'field': 'ratio_vs_cpp', 'from': 1.0, 'to': 0.8893, 'delta': -0.1107, 'improved': True}
  {'benchmark': 'heat_equation_2d', 'field': 'ratio_vs_cpp', 'from': 1.0228, 'to': 0.8381, 'delta': -0.1847, 'improved': True}
  {'benchmark': 'three_body', 'field': 'ratio_vs_cpp', 'from': 1.0, 'to': 0.9898, 'delta': -0.0102, 'improved': True}
  {'benchmark': 'wave_equation_1d', 'field': 'ratio_vs_cpp', 'from': 0.9587, 'to': 0.9934, 'delta': 0.0347, 'improved': False}
  {'benchmark': 'keepalive_pipelining', 'field': 'ratio_vs_cpp', 'from': 0.4608, 'to': 0.4284, 'delta': -0.0324, 'improved': True}
  {'benchmark': 'lb_least_conn', 'field': 'status', 'from': 'green', 'to': 'unknown'}
  {'benchmark': 'lb_peer_down', 'field': 'status', 'from': 'green', 'to': 'unknown'}
  {'benchmark': 'lb_round_robin', 'field': 'status', 'from': 'green', 'to': 'unknown'}
  {'benchmark': 'proxy_loopback', 'field': 'status', 'from': 'green', 'to': 'unknown'}
  {'benchmark': 'static_large', 'field': 'status', 'from': 'yellow', 'to': 'green'}
==> full benchmark matrix (perf + HTTP oracles + exploits)
benchmark-matrix-report: wrote /workspace/data/latest/benchmark-matrix.json and /workspace/data/latest/benchmark-matrix.md
matrix: /workspace/data/latest/benchmark-matrix.md
...
## Step: step-9-wave9-auth-validate — 2026-05-21T11:59:20Z

M1 wave 9: lic validate-httpd-config + Bearer API key 401
...
ninja: no work to do.
==> li-httpd
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  623 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
runtime/li_rt_net.c:628:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  628 |     iov[iovcnt].iov_base = ptr_i(b);
      |                          ^ ~~~~~~~~
runtime/li_rt_net.c:741:10: warning: passing 'const char *' to parameter of type 'void *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  741 |   memcpy(ptr_i(p), "not found", 9);
      |          ^~~~~~~~
/usr/include/string.h:43:39: note: passing argument to parameter '__dest' here
   43 | extern void *memcpy (void *__restrict __dest, const void *__restrict __src,
      |                                       ^
runtime/li_rt_net.c:3733:29: warning: passing 'const char *' to parameter of type 'void *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
 3733 |   ssize_t n = read((int)fd, ptr_i(buf), (size_t)max_bytes);
      |                             ^~~~~~~~~~
/usr/include/unistd.h:371:38: note: passing argument to parameter '__buf' here
  371 | extern ssize_t read (int __fd, void *__buf, size_t __nbytes) __wur
      |                                      ^
runtime/li_rt_net.c:3796:10: warning: passing 'const char *' to parameter of type 'void *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
 3796 |   memcpy(ptr_i(dst) + off, ptr_i(src), (size_t)n);
      |          ^~~~~~~~~~~~~~~~
/usr/include/string.h:43:39: note: passing argument to parameter '__dest' here
   43 | extern void *memcpy (void *__restrict __dest, const void *__restrict __src,
      |                                       ^
runtime/li_rt_net.c:3804:20: warning: passing 'const char *' to parameter of type 'char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
 3804 |   int n = snprintf(ptr_i(buf), (size_t)cap,
      |                    ^~~~~~~~~~
/usr/include/stdio.h:385:39: note: passing argument to parameter '__s' here
  385 | extern int snprintf (char *__restrict __s, size_t __maxlen,
      |                                       ^
runtime/li_rt_net.c:4007:29: warning: passing 'const char *' to parameter of type 'void *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
 4007 |   ssize_t r = recv((int)fd, ptr_i(buf), (size_t)cap, 0);
      |                             ^~~~~~~~~~
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
simd_dot cpp wall_time=0.0557s (median of 1)
simd_dot rust wall_time=0.0520s (median of 1)
simd_dot julia wall_time=0.0513s (median of 1)
simd_dot li wall_time=0.0008s (median of 1)
ok simd_dot
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  623 |     iov[iovcnt].iov_base = ptr_i(a);
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
matmul_naive cpp wall_time=0.0025s (median of 1)
matmul_naive rust wall_time=0.0025s (median of 1)
matmul_naive julia wall_time=0.0035s (median of 1)
matmul_naive li wall_time=0.0034s (median of 1)
ok matmul_naive
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
reduce_sum cpp wall_time=0.3078s (median of 1)
reduce_sum rust wall_time=0.3112s (median of 1)
reduce_sum julia wall_time=0.3048s (median of 1)
reduce_sum li wall_time=0.3045s (median of 1)
ok reduce_sum
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  623 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
7 warnings generated.
horner_pure_li cpp wall_time=0.0011s (median of 1)
horner_pure_li rust wall_time=0.0008s (median of 1)
horner_pure_li julia wall_time=0.0009s (median of 1)
horner_pure_li li wall_time=0.0004s (median of 1)
ok horner_pure_li
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
md_lennard_jones cpp wall_time=2.6093s (median of 1)
md_lennard_jones rust wall_time=2.6066s (median of 1)
md_lennard_jones julia wall_time=2.5966s (median of 1)
md_lennard_jones li wall_time=0.0026s (median of 1)
ok md_lennard_jones
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  623 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
7 warnings generated.
three_body cpp wall_time=0.2438s (median of 1)
three_body rust wall_time=0.2443s (median of 1)
three_body julia wall_time=0.2440s (median of 1)
three_body li wall_time=0.2437s (median of 1)
ok three_body
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  623 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
nbody_gravity cpp wall_time=1.1693s (median of 1)
nbody_gravity rust wall_time=1.1701s (median of 1)
nbody_gravity julia wall_time=1.1707s (median of 1)
nbody_gravity li wall_time=1.1699s (median of 1)
ok nbody_gravity
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  623 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
harmonic_oscillator_chain cpp wall_time=0.1117s (median of 1)
harmonic_oscillator_chain rust wall_time=0.1018s (median of 1)
harmonic_oscillator_chain julia wall_time=0.0885s (median of 1)
harmonic_oscillator_chain li wall_time=0.0831s (median of 1)
ok harmonic_oscillator_chain
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  623 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
wave_equation_1d cpp wall_time=1.7905s (median of 1)
wave_equation_1d rust wall_time=1.6640s (median of 1)
wave_equation_1d julia wall_time=1.6912s (median of 1)
wave_equation_1d li wall_time=1.7771s (median of 1)
ok wave_equation_1d
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  623 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
heat_equation_2d cpp wall_time=0.1363s (median of 1)
heat_equation_2d rust wall_time=0.1354s (median of 1)
heat_equation_2d julia wall_time=0.1328s (median of 1)
heat_equation_2d li wall_time=0.1466s (median of 1)
ok heat_equation_2d
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  623 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
double_pendulum cpp wall_time=0.3176s (median of 1)
double_pendulum rust wall_time=0.3176s (median of 1)
double_pendulum julia wall_time=0.3195s (median of 1)
double_pendulum li wall_time=0.3177s (median of 1)
ok double_pendulum
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  623 |     iov[iovcnt].iov_base = ptr_i(a);
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
advection_diffusion_2d cpp wall_time=0.1108s (median of 1)
advection_diffusion_2d rust wall_time=0.1042s (median of 1)
advection_diffusion_2d julia wall_time=0.1096s (median of 1)
advection_diffusion_2d li wall_time=0.1099s (median of 1)
ok advection_diffusion_2d
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  623 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
wave_equation_2d cpp wall_time=0.2724s (median of 1)
wave_equation_2d rust wall_time=0.2921s (median of 1)
wave_equation_2d julia wall_time=0.2756s (median of 1)
wave_equation_2d li wall_time=0.2776s (median of 1)
ok wave_equation_2d
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  623 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
sph_dam_break_2d cpp wall_time=0.8361s (median of 1)
sph_dam_break_2d rust wall_time=0.8360s (median of 1)
sph_dam_break_2d julia wall_time=0.8429s (median of 1)
sph_dam_break_2d li wall_time=0.8400s (median of 1)
ok sph_dam_break_2d
module:1:1: error [E0301]: Every `extern proc` must declare what must be true before it runs (`requires`).
module:1:1: error [E0301]: Every `extern proc` must declare what it guarantees on exit (`ensures`).
module:1:1: error [E0301]: Every `extern proc` must declare what must be true before it runs (`requires`).
...
lic_check_contracts lic build wall_time=0.0020s
async_await_chain li wall_time=0.0008s
security_security_corpus wall_time=0.1285s
security_security_cve_patterns wall_time=0.0232s
security_security_webserver_registry wall_time=0.0203s
updated /workspace/lic/benchmarks/results/latest.csv (+6 ecosystem rows)
==> tier 5 — HTTP multi-oracle (nginx, apache, lighttpd, node, bun, li)
bench_http: wrote 28 row(s) -> /workspace/vendor/lis-tier5/results/latest.csv
run-tier5-http-bench: ok (profile=nightly, oracles=nginx,apache,lighttpd,node,bun,li)
==> tier 5 — supplemental proxy_loopback (li_epoll + li c_epoll vs nginx)
2026/05/21 12:05:01 [notice] 91736#91736: signal process started
static_small li=91979 nginx=119031
Traceback (most recent call last):
  File "/workspace/scripts/tier5-http-bench.py", line 464, in <module>
    raise SystemExit(main())
                     ^^^^^^
  File "/workspace/scripts/tier5-http-bench.py", line 317, in main
    li_ka = bench_runs(
            ^^^^^^^^^^^
  File "/workspace/scripts/tier5-http-bench.py", line 105, in bench_runs
    wrk_rps(url, threads=threads, conn=conn, duration=duration, pipeline=pipeline)
  File "/workspace/scripts/tier5-http-bench.py", line 94, in wrk_rps
...
subprocess.CalledProcessError: Command '['wrk', '-t8', '-c200', '-d10s', '-s', '/tmp/wrk-http-pipeline.lua', 'http://127.0.0.1:18090/file.bin', '--', '8']' returned non-zero exit status 1.
WARN: tier5 supplemental http failed
==> tier 5 — HTTP exploits (TIER5_EXPLOIT_PROFILE=pr)
exploit_http: 36 row(s) -> /workspace/vendor/lis-tier5/results/exploit_report.csv (0 fail)
run-tier5-http-exploits: ok (pr, langs=nginx,apache,li, csv=/workspace/vendor/lis-tier5/results/exploit_report.csv)
merged tier5 (latest.csv + extra) into /workspace/lic/benchmarks/results/latest.csv
...
build-summary-li: skip (lic lacks std/summary — PH-IO-7)
wrote /workspace/data/latest/summary.json (33 rows, 33 charts)
recorded 2026-05-21T120531Z.json (14 deltas vs previous)
regression check failed: matmul_blocked, matmul_naive, static_large
==> benchmark status report
=== Benchmark failures report ===
Dashboard: https://li-langverse.github.io/benchmarks/
generated_at: 2026-05-21T12:05:31.637172+00:00

RED (3):
  matmul_blocked               tier=1    1.525×  lic  PH=PH-5b
  matmul_naive                 tier=1    1.360×  lic  PH=PH-5b,PH-7e
  static_large                 tier=5    1.134×  lis  PH=PH-H

GREEN near threshold (>1.0× cpp, 5):
  heat_equation_2d             tier=2    1.076×  lic  PH=PH-5b
  wave_equation_2d             tier=2    1.019×  lic  PH=PH-5b
  sph_dam_break_2d             tier=2    1.005×  lic  PH=PH-5b
  nbody_gravity                tier=2    1.000×  lic  PH=PH-5b
  double_pendulum              tier=2    1.000×  lic  PH=PH-5b
...
Since last snapshot (14 deltas):
  {'benchmark': 'horner_pure_li', 'field': 'ratio_vs_cpp', 'from': 0.8182, 'to': 0.3636, 'delta': -0.4546, 'improved': True}
  {'benchmark': 'matmul_blocked', 'field': 'status', 'from': 'green', 'to': 'red'}
  {'benchmark': 'matmul_blocked', 'field': 'ratio_vs_cpp', 'from': 1.0192, 'to': 1.5248, 'delta': 0.5056, 'improved': False}
  {'benchmark': 'matmul_naive', 'field': 'status', 'from': 'green', 'to': 'red'}
  {'benchmark': 'matmul_naive', 'field': 'ratio_vs_cpp', 'from': 0.6857, 'to': 1.36, 'delta': 0.6743, 'improved': False}
  {'benchmark': 'reduce_sum', 'field': 'ratio_vs_cpp', 'from': 1.0444, 'to': 0.9893, 'delta': -0.0551, 'improved': True}
  {'benchmark': 'advection_diffusion_2d', 'field': 'ratio_vs_cpp', 'from': 1.0119, 'to': 0.9919, 'delta': -0.02, 'improved': True}
  {'benchmark': 'harmonic_oscillator_chain', 'field': 'ratio_vs_cpp', 'from': 0.8893, 'to': 0.744, 'delta': -0.1453, 'improved': True}
  {'benchmark': 'heat_equation_2d', 'field': 'ratio_vs_cpp', 'from': 0.8381, 'to': 1.0756, 'delta': 0.2375, 'improved': False}
  {'benchmark': 'wave_equation_2d', 'field': 'ratio_vs_cpp', 'from': 1.0079, 'to': 1.0191, 'delta': 0.0112, 'improved': False}
  {'benchmark': 'keepalive_pipelining', 'field': 'ratio_vs_cpp', 'from': 0.4284, 'to': 0.4028, 'delta': -0.0256, 'improved': True}
  {'benchmark': 'static_large', 'field': 'status', 'from': 'green', 'to': 'red'}
  {'benchmark': 'static_large', 'field': 'ratio_vs_cpp', 'from': 0.9829, 'to': 1.1337, 'delta': 0.1508, 'improved': False}
  {'benchmark': 'static_small', 'field': 'ratio_vs_cpp', 'from': 0.599, 'to': 0.6223, 'delta': 0.0233, 'improved': False}
==> full benchmark matrix (perf + HTTP oracles + exploits)
benchmark-matrix-report: wrote /workspace/data/latest/benchmark-matrix.json and /workspace/data/latest/benchmark-matrix.md
matrix: /workspace/data/latest/benchmark-matrix.md
==> done — see data/latest/summary.json and data/latest/benchmark-matrix.md
...
## Step: step-10-lic-compat-bench — 2026-05-21T12:11:45Z

Full suite on cursor/httpd-masterplan-54aa (epoll li-httpd); main uses routing oracle stub
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
simd_dot cpp wall_time=0.0581s (median of 1)
simd_dot rust wall_time=0.0536s (median of 1)
simd_dot julia wall_time=0.0528s (median of 1)
simd_dot li wall_time=0.0009s (median of 1)
ok simd_dot
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  623 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
7 warnings generated.
matmul_naive cpp wall_time=0.0025s (median of 1)
matmul_naive rust wall_time=0.0024s (median of 1)
matmul_naive julia wall_time=0.0025s (median of 1)
matmul_naive li wall_time=0.0035s (median of 1)
ok matmul_naive
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
...
matmul_blocked rust wall_time=0.0100s (median of 1)
matmul_blocked julia wall_time=0.0102s (median of 1)
matmul_blocked li wall_time=0.0155s (median of 1)
ok matmul_blocked
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  623 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
reduce_sum cpp wall_time=0.3074s (median of 1)
reduce_sum rust wall_time=0.3034s (median of 1)
reduce_sum julia wall_time=0.2994s (median of 1)
reduce_sum li wall_time=0.3005s (median of 1)
ok reduce_sum
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  623 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
md_lennard_jones cpp wall_time=2.6058s (median of 1)
md_lennard_jones rust wall_time=2.5958s (median of 1)
md_lennard_jones julia wall_time=2.6095s (median of 1)
md_lennard_jones li wall_time=0.0026s (median of 1)
ok md_lennard_jones
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  623 |     iov[iovcnt].iov_base = ptr_i(a);
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
three_body cpp wall_time=0.2440s (median of 1)
three_body rust wall_time=0.2438s (median of 1)
three_body julia wall_time=0.2437s (median of 1)
three_body li wall_time=0.2435s (median of 1)
ok three_body
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
nbody_gravity cpp wall_time=1.1705s (median of 1)
nbody_gravity rust wall_time=1.1743s (median of 1)
nbody_gravity julia wall_time=1.1703s (median of 1)
nbody_gravity li wall_time=1.1699s (median of 1)
ok nbody_gravity
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  623 |     iov[iovcnt].iov_base = ptr_i(a);
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
harmonic_oscillator_chain cpp wall_time=0.0837s (median of 1)
harmonic_oscillator_chain rust wall_time=0.0885s (median of 1)
harmonic_oscillator_chain julia wall_time=0.0830s (median of 1)
harmonic_oscillator_chain li wall_time=0.1017s (median of 1)
ok harmonic_oscillator_chain
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  623 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
wave_equation_1d cpp wall_time=1.6620s (median of 1)
wave_equation_1d rust wall_time=1.6663s (median of 1)
wave_equation_1d julia wall_time=1.6918s (median of 1)
wave_equation_1d li wall_time=1.6637s (median of 1)
ok wave_equation_1d
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  623 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
heat_equation_2d cpp wall_time=0.1322s (median of 1)
heat_equation_2d rust wall_time=0.1268s (median of 1)
heat_equation_2d julia wall_time=0.1324s (median of 1)
heat_equation_2d li wall_time=0.1268s (median of 1)
ok heat_equation_2d
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  623 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
double_pendulum cpp wall_time=0.3187s (median of 1)
double_pendulum rust wall_time=0.3180s (median of 1)
double_pendulum julia wall_time=0.3179s (median of 1)
double_pendulum li wall_time=0.3186s (median of 1)
ok double_pendulum
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  623 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
advection_diffusion_2d cpp wall_time=0.1118s (median of 1)
advection_diffusion_2d rust wall_time=0.1143s (median of 1)
advection_diffusion_2d julia wall_time=0.1109s (median of 1)
advection_diffusion_2d li wall_time=0.1242s (median of 1)
ok advection_diffusion_2d
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  623 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
/usr/include/x86_64-linux-gnu/sys/socket.h:145:38: note: passing argument to parameter '__buf' here
  145 | extern ssize_t recv (int __fd, void *__buf, size_t __n, int __flags);
      |                                      ^
7 warnings generated.
wave_equation_2d cpp wall_time=0.2769s (median of 1)
wave_equation_2d rust wall_time=0.2916s (median of 1)
wave_equation_2d julia wall_time=0.2766s (median of 1)
wave_equation_2d li wall_time=0.2767s (median of 1)
ok wave_equation_2d
runtime/li_rt_net.c:623:26: warning: assigning to 'void *' from 'const char *' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]
  623 |     iov[iovcnt].iov_base = ptr_i(a);
      |                          ^ ~~~~~~~~
...
7 warnings generated.
sph_dam_break_2d cpp wall_time=0.8406s (median of 1)
sph_dam_break_2d rust wall_time=0.8394s (median of 1)
sph_dam_break_2d julia wall_time=0.8365s (median of 1)
sph_dam_break_2d li wall_time=0.8364s (median of 1)
ok sph_dam_break_2d
module:1:1: error [E0301]: Every `extern proc` must declare what must be true before it runs (`requires`).
module:1:1: error [E0301]: Every `extern proc` must declare what it guarantees on exit (`ensures`).
module:1:1: error [E0301]: Every `extern proc` must declare what must be true before it runs (`requires`).
...
lic_check_contracts lic build wall_time=0.0020s
async_await_chain li wall_time=0.0008s
security_security_corpus wall_time=0.1274s
security_security_cve_patterns wall_time=0.0220s
security_security_webserver_registry wall_time=0.0201s
updated /workspace/lic/benchmarks/results/latest.csv (+6 ecosystem rows)
==> tier 5 — HTTP multi-oracle (nginx, apache, lighttpd, node, bun, li)
bench_http: wrote 28 row(s) -> /workspace/vendor/lis-tier5/results/latest.csv
run-tier5-http-bench: ok (profile=nightly, oracles=nginx,apache,lighttpd,node,bun,li)
==> tier 5 — supplemental proxy_loopback (li_epoll + li c_epoll vs nginx)
2026/05/21 12:17:26 [notice] 101141#101141: signal process started
2026/05/21 12:18:08 [notice] 101185#101185: signal process started
2026/05/21 12:19:11 [notice] 101255#101255: signal process started
static_small li=103408 nginx=130819
keepalive_pipelining li=147400 nginx=116923
proxy_loopback li=0 li_c=0 nginx=41981
tier5-http-bench: wrote 7 rows -> /workspace/lic/benchmarks/results/http_tier5.csv
==> tier 5 — HTTP exploits (TIER5_EXPLOIT_PROFILE=pr)
exploit_http: 36 row(s) -> /workspace/vendor/lis-tier5/results/exploit_report.csv (0 fail)
run-tier5-http-exploits: ok (pr, langs=nginx,apache,li, csv=/workspace/vendor/lis-tier5/results/exploit_report.csv)
...
build-summary-li: skip (lic lacks std/summary — PH-IO-7)
wrote /workspace/data/latest/summary.json (33 rows, 33 charts)
recorded 2026-05-21T121931Z.json (12 deltas vs previous)
regression check failed: matmul_blocked, matmul_naive
==> benchmark status report
=== Benchmark failures report ===
Dashboard: https://li-langverse.github.io/benchmarks/
generated_at: 2026-05-21T12:19:31.845499+00:00

RED (2):
  matmul_blocked               tier=1    1.535×  lic  PH=PH-5b
  matmul_naive                 tier=1    1.400×  lic  PH=PH-5b,PH-7e

YELLOW (1):
  harmonic_oscillator_chain    tier=2    1.215×  lic  PH=PH-5b

GREEN near threshold (>1.0× cpp, 2):
  advection_diffusion_2d       tier=2    1.111×  lic  PH=PH-5b
  wave_equation_1d             tier=2    1.001×  lic  PH=PH-5b
...
Since last snapshot (12 deltas):
  {'benchmark': 'horner_pure_li', 'field': 'ratio_vs_cpp', 'from': 0.3636, 'to': 0.4444, 'delta': 0.0808, 'improved': False}
  {'benchmark': 'matmul_naive', 'field': 'ratio_vs_cpp', 'from': 1.36, 'to': 1.4, 'delta': 0.04, 'improved': False}
  {'benchmark': 'reduce_sum', 'field': 'ratio_vs_cpp', 'from': 0.9893, 'to': 0.9776, 'delta': -0.0117, 'improved': True}
  {'benchmark': 'advection_diffusion_2d', 'field': 'ratio_vs_cpp', 'from': 0.9919, 'to': 1.1109, 'delta': 0.119, 'improved': False}
  {'benchmark': 'harmonic_oscillator_chain', 'field': 'status', 'from': 'green', 'to': 'yellow'}
  {'benchmark': 'harmonic_oscillator_chain', 'field': 'ratio_vs_cpp', 'from': 0.744, 'to': 1.2151, 'delta': 0.4711, 'improved': False}
  {'benchmark': 'heat_equation_2d', 'field': 'ratio_vs_cpp', 'from': 1.0756, 'to': 0.9592, 'delta': -0.1164, 'improved': True}
  {'benchmark': 'wave_equation_2d', 'field': 'ratio_vs_cpp', 'from': 1.0191, 'to': 0.9993, 'delta': -0.0198, 'improved': True}
  {'benchmark': 'keepalive_pipelining', 'field': 'ratio_vs_cpp', 'from': 0.4028, 'to': 0.3897, 'delta': -0.0131, 'improved': True}
  {'benchmark': 'static_large', 'field': 'status', 'from': 'red', 'to': 'green'}
  {'benchmark': 'static_large', 'field': 'ratio_vs_cpp', 'from': 1.1337, 'to': 0.9476, 'delta': -0.1861, 'improved': True}
  {'benchmark': 'static_small', 'field': 'ratio_vs_cpp', 'from': 0.6223, 'to': 0.5193, 'delta': -0.103, 'improved': True}
==> full benchmark matrix (perf + HTTP oracles + exploits)
benchmark-matrix-report: wrote /workspace/data/latest/benchmark-matrix.json and /workspace/data/latest/benchmark-matrix.md
matrix: /workspace/data/latest/benchmark-matrix.md
==> done — see data/latest/summary.json and data/latest/benchmark-matrix.md
