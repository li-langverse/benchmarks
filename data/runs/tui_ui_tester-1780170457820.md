# tui_ui_tester run `tui_ui_tester-1780170457820`

**Started:** 2026-05-30T19:48Z · **Source:** proactive · **Status:** complete
...
- **Piped stdin workaround** captures 107 B ANSI frame (exit 0) — layout auditable once harness injects input.
...
- **Control plane:** 9 prior runs today ended `error`; this pass completes digest + remediation manifest.
...
**Evidence:** `data/latest-tui-ui-run/ui-audit.json` (2026-05-30T19:50Z)
