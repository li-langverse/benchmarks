...
- **Learned-from URLs** (survey): Numerical Recipes [Ch. 5 PDF](https://numerical.recipes/book/bookcpdf/c5-3.pdf); Eigen [efficient matrix product](https://eigen.tuxfamily.org/dox/TopicWritingEfficientProductExpression.html); BLIS [kernels doc](https://github.com/flame/blis/blob/master/docs/KernelsHowTo.md); [how-to-optimize-gemm](https://github.com/flame/how-to-optimize-gemm/wiki); Hairer GNINT lecture [PDF snapshot](http://mate.uniovi.es/~carpet/GNI2006/PROGRAMME/haireryesterday.pdf); LeVeque [FDM book](https://faculty.washington.edu/~rjl/fdmbook/); PETSc [Users Manual](https://petsc.org/main/manual/); SUNDIALS [CVODE docs](https://sundials.readthedocs.io/en/latest/cvode/).
